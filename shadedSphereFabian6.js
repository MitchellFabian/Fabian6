...
// Menu for selecting Phong vs Gouraud
...
//Subdivision Slider
    ...
    document.getElementById("slider").onchange = function(event) {
        ...
        pointsArray = [];
        normalsArray = [];
        document.getElementById("subdivisionText").innerHTML = event.target.value;
        init();
    };
...
//Shininess Slider
    ...
    document.getElementById("shine").onchange = function(event) {
        ...
        document.getElementById("shineText").innerHTML = event.target.value;
        init();
    };

//Light Specular Sliders
...
//Material Ambient Sliders
 ...
 //Light Position Sliders
    ...
    document.getElementById("lightPhi").onchange = function(event) {
        phi = event.target.value;
        document.getElementById("lightPhiText").innerHTML = event.target.value;
        init();
    };

    document.getElementById("lightTheta").onchange = function(event) {
        theta = event.target.value;
        document.getElementById("lightThetaText").innerHTML = event.target.value;
        init();
    };
